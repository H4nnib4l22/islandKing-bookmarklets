 ...
 *   Echtes Feldschema je Eintrag (live verifiziert 2026-09-14, Nutzer-
 ...
 * v1.6.14: BODY_HEIGHT 330px -> 190px (Nutzerwunsch) - bei wenig Inhalt
 * (keine Favoriten, eingeklappte Mitgliederliste: nur Statuszeile +
 * "Alle Mitglieder (n)"-Toggle) blieb sonst rund 280px Leerraum. 190px
...
(function () {
  ...
  // Positions-Menue als eigenes body-Element statt Panel-Kind: falls das
  // Panel spaeter mal overflow:hidden bekommt (wie die anderen drei), soll
  // das Menue nicht mit abgeschnitten werden - vorsorglich gleich konsistent
  // mit Reisezeitenrechner/Kampfrechner/Ressourcenrechner/Spy-Report-Lookup.
  ...
  // Ziehen ueberall auf dem Panel moeglich, nicht nur an der Titelzeile -
  // nur im freien Modus aktiv. Siehe Reisezeitenrechner/Kampfrechner fuer
  // die ausfuehrliche Begruendung der Ausschlussregeln (Formularelemente
  // immer ausschliessen, alles mit cursor:pointer ausserhalb der
  // Titelzeile ebenso - deckt hier zusaetzlich Favoriten-Pin/Entfernen,
  // Tab-Buttons und die Gruppen-Toggles ab).
  let drag = null;
