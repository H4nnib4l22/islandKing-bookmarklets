 ...
 * v1.2.7: Panel-Breite 380px -> 420px (Nutzerwunsch) - die Scrollbar
...
(function () {
  ...
  // statt echtem Bin-Packing: nach dem Ausklappen pruefen, ob die eigene
  // Box irgendein anderes Panel ueberlappt, und falls ja, unter dessen
  // Unterkante schieben - wiederholt (max. 6x) fuer Ketten mehrerer
  // ueberlappender Panels.
  ...
  // positioniertes Kind-Menue ab, sobald das Panel eingeklappt (= kurz)
  // ist. Als position:fixed-Element auf Body-Ebene, am Zahnrad-Icon
  // ausgerichtet, umgeht das die Beschneidung komplett.
  ...
  // die ausfuehrliche Begruendung der Ausschlussregeln.
  let drag = null;
